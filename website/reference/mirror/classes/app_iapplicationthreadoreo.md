# mirror · IApplicationThreadOreo

::: tip 源码路径
[`src/main/java/mirror/android/app/IApplicationThreadOreo.java`](https://github.com/android-security-engineer/VirtualXposed-skills/blob/vxp/VirtualApp/lib/src/main/java/mirror/android/app/IApplicationThreadOreo.java)
:::
...
```mermaid
flowchart LR
  SC["影子类<br/>mirror.IApplicationThreadOreo"] -->|"RefClass.load"| BIND["绑定真实<br/>IApplicationThreadOreo"]
