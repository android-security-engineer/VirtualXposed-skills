# mirror · ReceiverResourceM

::: tip 源码路径
[`src/main/java/mirror/android/rms/resource/ReceiverResourceM.java`](https://github.com/android-security-engineer/VirtualXposed-skills/blob/vxp/VirtualApp/lib/src/main/java/mirror/android/rms/resource/ReceiverResourceM.java)
:::
...
```mermaid
flowchart LR
  SC["影子类<br/>mirror.ReceiverResourceM"] -->|"RefClass.load"| BIND["绑定真实<br/>ReceiverResourceM"]
