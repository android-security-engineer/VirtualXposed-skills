# mirror · ActivityThread

::: tip 源码路径
[`src/main/java/mirror/android/app/ActivityThread.java`](https://github.com/android-security-engineer/VirtualXposed-skills/blob/vxp/VirtualApp/lib/src/main/java/mirror/android/app/ActivityThread.java)
:::
...
```mermaid
flowchart LR
  SC["影子类<br/>mirror.ActivityThread"] -->|"RefClass.load"| BIND["绑定真实<br/>ActivityThread"]
