# mirror · IActivityManagerL

::: tip 源码路径
[`src/main/java/mirror/android/app/IActivityManagerL.java`](https://github.com/android-security-engineer/VirtualXposed-skills/blob/vxp/VirtualApp/lib/src/main/java/mirror/android/app/IActivityManagerL.java)
:::
...
```mermaid
flowchart LR
  SC["影子类<br/>mirror.IActivityManagerL"] -->|"RefClass.load"| BIND["绑定真实<br/>IActivityManagerL"]
