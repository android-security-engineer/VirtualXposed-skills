# mirror · ParceledListSlice

::: tip 源码路径
[`src/main/java/mirror/android/content/pm/ParceledListSlice.java`](https://github.com/android-security-engineer/VirtualXposed-skills/blob/vxp/VirtualApp/lib/src/main/java/mirror/android/content/pm/ParceledListSlice.java)
:::
...
```mermaid
flowchart LR
  SC["影子类<br/>mirror.ParceledListSlice"] -->|"RefClass.load"| BIND["绑定真实<br/>ParceledListSlice"]
