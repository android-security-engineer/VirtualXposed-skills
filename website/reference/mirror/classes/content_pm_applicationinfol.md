# mirror · ApplicationInfoL

::: tip 源码路径
[`src/main/java/mirror/android/content/pm/ApplicationInfoL.java`](https://github.com/android-security-engineer/VirtualXposed-skills/blob/vxp/VirtualApp/lib/src/main/java/mirror/android/content/pm/ApplicationInfoL.java)
:::

镜像真实类 `android.content.pm.ApplicationInfoL`，用 Ref 引用对象包装其隐藏成员。
...
```mermaid
flowchart LR
  SC["影子类<br/>mirror.ApplicationInfoL"] -->|"RefClass.load"| BIND["绑定真实<br/>ApplicationInfoL"]
