# mirror · LoadedApkHuaWei

::: tip 源码路径
[`src/main/java/mirror/android/app/LoadedApkHuaWei.java`](https://github.com/android-security-engineer/VirtualXposed-skills/blob/vxp/VirtualApp/lib/src/main/java/mirror/android/app/LoadedApkHuaWei.java)
:::
...
```mermaid
flowchart LR
  SC["影子类<br/>mirror.LoadedApkHuaWei"] -->|"RefClass.load"| BIND["绑定真实<br/>LoadedApkHuaWei"]
