...
::: tip 源码路径
[`src/main/java/mirror/android/telephony/CellInfoCdma.java`](https://github.com/android-security-engineer/VirtualXposed-skills/blob/vxp/VirtualApp/lib/src/main/java/mirror/android/telephony/CellInfoCdma.java)
:::

镜像真实类 `android.telephony.CellInfoCdma`，用 Ref 引用对象包装其隐藏成员。
...
```mermaid
flowchart LR
  SC["影子类<br/>mirror.CellInfoCdma"] -->|"RefClass.load"| BIND["绑定真实<br/>CellInfoCdma"]
