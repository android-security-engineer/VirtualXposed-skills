# mirror · IApplicationThreadJBMR1

::: tip 源码路径
[`src/main/java/mirror/android/app/IApplicationThreadJBMR1.java`](https://github.com/android-security-engineer/VirtualXposed-skills/blob/vxp/VirtualApp/lib/src/main/java/mirror/android/app/IApplicationThreadJBMR1.java)
:::
...
```mermaid
flowchart LR
  SC["影子类<br/>mirror.IApplicationThreadJBMR1"] -->|"RefClass.load"| BIND["绑定真实<br/>IApplicationThreadJBMR1"]
